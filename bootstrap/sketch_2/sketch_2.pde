...
void setup() {
  ...
  l_1=new Dline("comm_1.csv", 1);
  l_2=new Dline("comm_2.csv", 2);
  l_3=new Dline("comm_3.csv", 3);
...
class Dline {
  ...
  void display() {
    stroke(0, 0, 255, 5);
    strokeWeight(1);
    float x_1=map(orig.get(i), 0, 10000, 0, 1000);
    line(x_1, order, x_1, order+10);

    stroke(255, 0, 0, 5);
    strokeWeight(1);
    float x_2=map(curr.get(i), 0, 10000, 0, 1000);
